...
const TermsOfService = () => {
  return (
    <>
      ...
      <p>Our Terms of Service were last updated on 07-21-2022.</p>
      <p>
      ...
      <p>
        ...
        <p>
          <p>
            ...
            "We", "Us" or "Our" in this Agreement) refers to YourSports.
          </p>
        </p>
        <p>
          <p>
        ...
        <p>
          <p>
            <strong>"Website"</strong> refers to YourSports, accessible from
      ...
      <p>
        ...
        copyright agent via email ([___COPYRIGHT_AGENT_CONTACT_EMAIL___]) and
      ...
      <p>
        <p>By visiting this page on our website: http://34.136.124.189:3000</p>
        <p>By sending us an email: ksareen@sfsu.edu</p>
      </p>
      <p></p>
    </>
  );
